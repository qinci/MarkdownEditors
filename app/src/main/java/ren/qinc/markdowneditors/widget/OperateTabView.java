 ...
 */
public class OperateTabView extends HorizontalScrollView {

    private LinearLayout mLayout;
    private LayoutInflater mInflater;

    public OperateTabView(Context context) {
        super(context);
        init();
    }

    public OperateTabView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public OperateTabView(Context context, AttributeSet attrs, int defStyleAttr) {
